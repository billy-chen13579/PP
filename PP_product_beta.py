...
def homepage():
    up_frame = Frame(root, bg='#2200AA', width=1200, height=300)
    up_frame.pack()
    down_frame = Frame(root, bg='#FFFFFF', width=1200, height=700 - 300)
    down_frame.pack()
    ...
    intro_button = Button(up_frame, text='Click Me!!!', fg='Black', font=('Times New Roman', 22), command=open_url)
    ...
    def open_source():
        webb.open('https://github.com/billy-chen13579')  # 暫時

    source_button = Button(up_frame, text='Source Code', fg='Black', font=('Times New Roman', 22), command=open_source)
    ...
    def yt_func():
        ...
        yt_frame = Frame(root, bg='#CC0000', width=1200, height=300)
        yt_frame.pack()

        lb1 = Label(yt_frame, text='Download Path:', bg='#CC0000', fg='#000000', font=('Times New Roman', 22))
        ...
        yt_frame2 = Frame(root, bg='#888888', width=1200, height=700 - 300)
        yt_frame2.pack()
        ...
        sbar.place(rely=0.5, relx=0.87, anchor='center', relheight=0.85)
    ...
    def image_func():
        ...
        image_frame1 = Frame(root, bg='#DDDDDD', width=1200, height=100)
        image_frame1.pack()
        image_frame2 = Frame(root, bg='#DDDDDD', width=1200, height=700 - 100)
        image_frame2.pack()
        ...
        def show():
            ...
            if word == 'Download one image':
                ...
                sbar.place(rely=0.65, relx=0.87, anchor='center', relheight=0.57)
    ...
    def amazon_func():
        ...
        amazon_frame1 = Frame(root, bg='#FFAA33', width=1200, height=200)
        amazon_frame1.pack()

        amazon_frame2 = Frame(root, bg="#FFFFFF", width=1200, height=700 - 200)
        amazon_frame2.pack()
        ...
        listbox1 = Listbox(amazon_frame2, width=50, height=25)
        listbox1.place(relx=0.25, rely=0.55, anchor='center')

        sbar1 = Scrollbar(amazon_frame2)
        sbar1.place(relx=0.433, rely=0.55, anchor='center', relheight=0.855)
        ...
        listbox2 = Listbox(amazon_frame2, width=50, height=25)
        listbox2.place(relx=0.75, rely=0.55, anchor='center')

        sbar2 = Scrollbar(amazon_frame2)
        sbar2.place(relx=0.933, rely=0.55, anchor='center', relheight=0.855)
        ...
        btn1.place(relx=0.9, rely=0.4, anchor='center')
    ...
    def covid_func():
        ...
        covid_frame1 = Frame(root, bg='#BBFF66', width=1200, height=300)
        covid_frame1.pack()

        covid_frame2 = Frame(root, bg='#FFFFFF', width=1200, height=700 - 300)
        covid_frame2.pack()
        ...
        listbox1 = Listbox(covid_frame2, width=100, height=20)
        listbox1.place(relx=0.5, rely=0.5, anchor='center')

        sbar1 = Scrollbar(covid_frame2)
        sbar1.place(relx=0.88, rely=0.5, relheight=0.86, anchor='center')
    ...
    def pchome_func():
        ...
        pchome_frame1 = Frame(root, bg='#CC0000', width=1200, height=300)
        pchome_frame1.pack()

        pchome_frame2 = Frame(root, bg='#00BBFF', width=1200, height=700 - 300)
        pchome_frame2.pack()
        ...
        listbox1 = Listbox(pchome_frame2, width=50, height=20)
        listbox1.place(relx=0.25, rely=0.55, anchor='center')

        sbar1 = Scrollbar(pchome_frame2)
        sbar1.place(relx=0.44, rely=0.55, anchor='center', relheight=0.855)
        ...
        listbox2 = Listbox(pchome_frame2, width=60, height=20)
        listbox2.place(relx=0.73, rely=0.55, anchor='center')

        sbar2 = Scrollbar(pchome_frame2)
        sbar2.place(relx=0.96, rely=0.55, anchor='center', relheight=0.855)
    ...
    button_yt = Button(down_frame, text='Youtube Download', fg='Black', font=('Times New Roman', 22), command=yt_func)
    button_amazon = Button(down_frame, text='Amazon', fg='Black', font=('Times New Roman', 22), command=amazon_func)
    button_pchome = Button(down_frame, text='PChome', fg='Black', font=('Times New Roman', 22), command=pchome_func)
    button_image = Button(down_frame, text='Image Download', fg='Black', font=('Times New Roman', 22),
                          command=image_func)
    button_covid = Button(down_frame, text='COVID cases', fg='Black', font=('Times New Roman', 22), command=covid_func)
